...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_LIST_TYPE = "Oops! The list type does not exist."
    INVALID_LIST_MATCH_RULE = "Oops! Invalid matching rule."
    INVALID_LIST_SUGGESTION = "Oops! Invalid disposal recommendation."
    INVALID_RISK_TYPE = "Oops! Invalid risk type."
    INVALID_STATUS = "Oops! Invalid list status."
    INVALID_LANGUAGE = "Oops! Unsupported language."
    APP_KEY_NOT_SUPPORT_UPDATES = "app key does not support updates."
